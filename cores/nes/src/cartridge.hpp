...
public:
    ...
    // Get all battery-backed save data (PRG RAM + any mapper-specific data like EEPROM)
    std::vector<uint8_t> get_save_data() const;

    // Set battery-backed save data (restores PRG RAM + mapper-specific data)
