...
private:
    ...
    // NTSC 4-step: 7457, 14913, 22371, 29829 (29830 reset)
    // NTSC 5-step: 7457, 14913, 22371, 37281 (37282 reset)
    // PAL 4-step:  8313, 16627, 24939, 33252 (33253 reset)
    // PAL 5-step:  8313, 16627, 24939, 41565 (41566 reset)
    int m_frame_step1 = 7457;
    int m_frame_step2 = 14913;
    int m_frame_step3 = 22371;
    int m_frame_step4 = 29829;  // Also IRQ point in 4-step mode
    int m_frame_step5 = 37281;  // 5-step mode only
    int m_frame_reset4 = 29830;
